...
class CaseStudy(models.Model):
    ...
    business_challenge = models.TextField(blank=True, default="")
    proposed_architecture = models.TextField(blank=True, default="")
    tech_stack = models.JSONField(default=list, blank=True)
    development_approach = models.TextField(blank=True, default="")
    modules_integration_security = models.TextField(blank=True, default="")
...
class Industry(models.Model):
    ...
    class Meta:
        ordering = ['-created_at']
        indexes = [
            models.Index(fields=['-created_at'], name='cms_ind_created_idx'),
            models.Index(fields=['status', '-created_at'], name='cms_ind_stat_created_idx'),
            models.Index(fields=['name'], name='cms_ind_name_idx'),
        ]
