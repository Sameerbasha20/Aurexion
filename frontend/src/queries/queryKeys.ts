...
export const queryKeys = {
  ...
  bdm: {
    ...
    opportunities: (filters?: Record<string, any>) => ["bdm", "opportunities", filters || {}] as const,
  },

  // CMS domain query keys
  cms: {
    all: () => ["cms"] as const,
    services: (filters?: Record<string, any>) => ["cms", "services", filters || {}] as const,
    serviceDetail: (idOrSlug: number | string) => ["cms", "services", String(idOrSlug)] as const,
    caseStudies: (filters?: Record<string, any>) => ["cms", "case-studies", filters || {}] as const,
    caseStudyDetail: (id: number | string) => ["cms", "case-studies", String(id)] as const,
    industries: (filters?: Record<string, any>) => ["cms", "industries", filters || {}] as const,
    categories: () => ["cms", "categories"] as const,
    blog: (filters?: Record<string, any>) => ["cms", "blog", filters || {}] as const,
  ...
  recruitment: {
    ...
    jobs: (filters?: Record<string, any>) => ["recruitment", "jobs", filters || {}] as const,
    jobDetail: (id: string) => ["recruitment", "jobs", id] as const,
    applications: (filters?: Record<string, any>) => ["recruitment", "applications", filters || {}] as const,
  ...
  portal: {
    all: () => ["portal"] as const,
    myTickets: (filters?: Record<string, any>) => ["portal", "my-tickets", filters || {}] as const,
    ticketDetail: (id: string | number) => ["portal", "tickets", String(id)] as const,
    projects: (filters?: Record<string, any>) => ["portal", "projects", filters || {}] as const,
    documents: (filters?: Record<string, any>) => ["portal", "documents", filters || {}] as const,
    requests: (filters?: Record<string, any>) => ["portal", "requests", filters || {}] as const,
  },
  ...
  administration: {
    ...
    users: (filters?: Record<string, any>) => ["administration", "users", filters || {}] as const,
    roles: () => ["administration", "roles"] as const,
    auditLogs: (filters?: Record<string, any>) => ["administration", "audit-logs", filters || {}] as const,
  },
};
