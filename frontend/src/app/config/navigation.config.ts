...
export const SIDEBAR_NAV: Record<string, NavItem[]> = {
  ADMIN: [
    ...
    { title: "Sales / BDM", path: "/admin/bdm-sales", icon: "TrendingUp" },
    { title: "Leads", path: "/admin/leads", icon: "Contact2" },
    { title: "Roles & Permissions", path: "/admin/roles", icon: "ShieldAlert" },
    { title: "Modules", path: "/admin/modules", icon: "FolderLock" },
    { title: "RFP Intake", path: "/admin/rfp", icon: "FileText" },
    { title: "Estimator", path: "/admin/estimator", icon: "Calculator" },
    { title: "Support Queue", path: "/admin/support", icon: "MessageSquareCode" },
    { title: "Recruitment Desk", path: "/admin/recruitment", icon: "Briefcase" },
    { title: "CMS Content", path: "/admin/cms", icon: "FileText" },
    { title: "Reports & Analytics", path: "/admin/reports", icon: "TrendingUp" },
    { title: "Audit Ledger", path: "/admin/audit-logs", icon: "History" },
