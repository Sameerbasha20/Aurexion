...
export const RelatedContent = ({ currentArticle }: { currentArticle: any }) => {
      ...
      <div className="grid md:grid-cols-3 gap-8">
        ...
        {currentArticle.relatedServices.length > 0 && (
          <div className="bg-muted/30 p-6 rounded-xl border border-border/40">
            ...
            <ul className="space-y-3">
              {currentArticle.relatedServices.map((service: any) => (
                <li key={service}>
        ...
        {currentArticle.relatedIndustries.length > 0 && (
          <div className="bg-muted/30 p-6 rounded-xl border border-border/40">
            ...
            <ul className="space-y-3">
              {currentArticle.relatedIndustries.map((industry: any) => (
                <li key={industry}>
        ...
        {currentArticle.relatedCaseStudies.length > 0 && (
          <div className="bg-muted/30 p-6 rounded-xl border border-border/40">
            ...
            <ul className="space-y-3">
              {currentArticle.relatedCaseStudies.map((cs: any) => (
                <li key={cs}>
