...
// duplicate authorId logic removed
    ...
    coverImage: resolveMediaUrl(apiArticle.cover_image || apiArticle.coverImage || apiArticle.coverimage || apiArticle.media) || staticArticle?.coverImage || (() => {
      ...
      return (categoryImages as Record<string, any>)[cat.toLowerCase()] || "/images/unsplash_1486406146926-c6.webp";
    })()
  } : staticArticle as any;
  ...
  return (
    <div className="bg-background min-h-screen">
      <SEO
        ...
        keywords={article.meta_keywords ? (article.meta_keywords as string).split(",").map((k: any) => k.trim()) : article.tags}
