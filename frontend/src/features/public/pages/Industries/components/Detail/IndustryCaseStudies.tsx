...
export const IndustryCaseStudies = ({ industry }: { industry: any }) => {
  ...
  const matchedCaseStudies = industry.relatedCaseStudies.map((slug: any) => {
    ...
    <section className="py-24 bg-background border-t border-border/10">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {matchedCaseStudies.map((cs: any, idx: number) => { return (
            <Link 
              key={idx}
