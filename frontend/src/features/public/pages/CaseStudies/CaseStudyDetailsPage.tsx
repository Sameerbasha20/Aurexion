...
export const CaseStudyDetailsPage = () => {
  ...
  const staticCaseStudy = caseStudiesData.find((cs: any) => cs.slug === slug);
  ...
  const caseStudy = apiCaseStudy ? {
    ...
    services: staticCaseStudy?.services || (apiCaseStudy.services ? apiCaseStudy.services.map((s: any) => s.slug) : [])
  } : staticCaseStudy;
  ...
  return (
    <div className="bg-background min-h-screen">
      <SEO
        ...
        ogImage={typeof caseStudy.coverImage === "string" ? caseStudy.coverImage : undefined}
        ogType="article"
      />
