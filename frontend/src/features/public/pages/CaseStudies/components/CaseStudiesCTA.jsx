      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-4xl mx-auto text-center border border-[#1b2b3d] bg-[#0b1420] p-10 md:p-14 rounded-2xl">
          ...
          <p className="text-base md:text-lg text-gray-400 mb-8 max-w-2xl mx-auto leading-relaxed">
            Consult with Aurexion's systems architects on custom software engineering, cloud modernization, and high-throughput platforms.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            >
              DISCUSS YOUR CHALLENGE <ArrowUpRight size={15} />
            </Link>
            <Link
              href="/rfp"
              className="inline-flex items-center justify-center px-8 py-3.5 bg-transparent text-white border border-[#1b2b3d] font-mono text-xs font-bold tracking-wider rounded uppercase hover:border-[#63f5e8]/50 hover:bg-[#0e1a2b] transition-all duration-200"
            >
              REQUEST A PROPOSAL
            </Link>
          </div>
