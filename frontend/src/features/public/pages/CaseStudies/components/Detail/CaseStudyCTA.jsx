  ...
  return (
    <section className="py-32 bg-[#050B14] relative overflow-hidden border-t border-primary/20">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-4xl mx-auto text-center border border-border/40 bg-card/10 backdrop-blur-sm p-12 md:p-20 rounded-2xl shadow-2xl">
          <h2 className="text-4xl md:text-5xl font-bold mb-6 text-white">Have a Similar Enterprise Challenge?</h2>
