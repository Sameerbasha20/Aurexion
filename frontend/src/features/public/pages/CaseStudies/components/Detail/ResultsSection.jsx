...
export const ResultsSection = ({ caseStudy }) => {
  ...
  return (
    <section className="py-10 bg-[#050B14] border-b border-border/10 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mx-auto mb-6">
          ...
          <h2 className="text-2xl sm:text-3xl font-bold text-white">Business Impact</h2>
        </div>

        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
          {caseStudy.results.map((result, idx) => (
            <div key={idx} className="p-6 bg-card/10 border border-primary/20 rounded-2xl text-center backdrop-blur-sm relative group overflow-hidden hover:border-primary/50 transition-colors shadow-lg">
