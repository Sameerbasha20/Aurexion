      ...
      try {
        ...
        if (result && Array.isArray(result) && result.length > 0) {
          ...
          const normalizedBackend = result.map((item: any) => ({
            ...
            coverImage: item.coverImage || item.imageUrl || "/webp_images/unsplash_1618005182384-a8.webp",
          }));
      ...
      try {
        ...
        if (result && Array.isArray(result) && result.length > 0) {
          const normalized = result.map((item: any) => ({
            ...
            coverImage: item.coverImage || item.media || item.imageUrl || "/webp_images/unsplash_1618005182384-a8.webp",
