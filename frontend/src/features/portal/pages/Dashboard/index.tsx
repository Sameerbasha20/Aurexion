...
const PortalRecentTicketsCard: React.FC<{ recentTickets: any[] }> = ({ recentTickets }) => (
  <Card>
...
const PortalModulesCard: React.FC = () => (
  <Card>
    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "1rem" }}>
        ...
        <>
          ...
          {stats.total === 0 ? (
            ...
            <div style={{ display: "grid", gap: "1.5rem", gridTemplateColumns: "repeat(auto-fit, minmax(320px, 1fr))" }}>
              <PortalRecentTicketsCard recentTickets={recentTickets} />
              <PortalModulesCard />
            </div>
          )}
        </>
